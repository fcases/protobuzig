...
pub const AppConfig = struct {
    ...
    pub const CrossConnectorDef_2 = struct {
        ...
        pub fn skribiAlTeksto(self: *CrossConnectorDef_2, allocator: all.Allocator, t_formato: encdec.TekstaFormato) ![]const u8 {
            return try encdec.skribiTiponAlTeksto(allocator, CrossConnectorDef_2, @as(*CrossConnectorDef_2, self), t_formato);
        }

        pub fn skribiAlDosiero(self: *CrossConnectorDef_2, allocator: all.Allocator, path: []const u8, t_formato: encdec.TekstaFormato) !void {
            try encdec.skribiTiponAlDosiero(allocator, CrossConnectorDef_2, @as(*CrossConnectorDef_2, self), path, t_formato);
        }

        pub fn legiElTeksto(allocator: all.Allocator, input: [:0]const u8, t_formato: encdec.TekstaFormato) !CrossConnectorDef_2 {
            return try encdec.legiTiponElTeksto(allocator, CrossConnectorDef_2, input, t_formato);
        }

        pub fn legiElDosiero(allocator: all.Allocator, path: [:0]const u8, t_formato: encdec.TekstaFormato) !CrossConnectorDef_2 {
            return try encdec.legiTiponElDosiero(allocator, CrossConnectorDef_2, path, t_formato);
        }
        ...
        pub fn seriigiAlBin(self: *CrossConnectorDef_2, allocator: all.Allocator, b_formato: encdec.BinaraFormato) ![]const u8 {
            return try seriigiTiponAlBin(allocator, CrossConnectorDef_2, @as(*CrossConnectorDef_2,self), b_formato);
        }

        pub fn seriigiAlDosiero(self: *CrossConnectorDef_2, allocator: all.Allocator, path: []const u8, b_formato: encdec.BinaraFormato) !void {
        ...
        pub fn deseriigiElBin(allocator: all.Allocator,input: []const u8, b_formato: encdec.BinaraFormato) !CrossConnectorDef_2 {
            return try deseriigiTiponElBin(allocator, CrossConnectorDef_2, input, b_formato);
        }

        pub fn deseriigiElDosiero(allocator: all.Allocator, path: [:0]const u8, b_formato: encdec.BinaraFormato) !CrossConnectorDef_2 {
...
pub const TransportCfg = struct {
    ...
    pub fn skribiAlTeksto(self: *TransportCfg, allocator: all.Allocator, t_formato: encdec.TekstaFormato) ![]const u8 {
        return try encdec.skribiTiponAlTeksto(allocator, TransportCfg, @as(*TransportCfg, self), t_formato);
    }

    pub fn skribiAlDosiero(self: *TransportCfg, allocator: all.Allocator, path: []const u8, t_formato: encdec.TekstaFormato) !void {
        try encdec.skribiTiponAlDosiero(allocator, TransportCfg, @as(*TransportCfg, self), path, t_formato);
    }

    pub fn legiElTeksto(allocator: all.Allocator, input: [:0]const u8, t_formato: encdec.TekstaFormato) !TransportCfg {
        return try encdec.legiTiponElTeksto(allocator, TransportCfg, input, t_formato);
    }

    pub fn legiElDosiero(allocator: all.Allocator, path: [:0]const u8, t_formato: encdec.TekstaFormato) !TransportCfg {
        return try encdec.legiTiponElDosiero(allocator, TransportCfg, path, t_formato);
    }
    ...
    pub fn seriigiAlBin(self: *TransportCfg, allocator: all.Allocator, b_formato: encdec.BinaraFormato) ![]const u8 {
        return try seriigiTiponAlBin(allocator, TransportCfg, @as(*TransportCfg,self), b_formato);
    }

    pub fn seriigiAlDosiero(self: *TransportCfg, allocator: all.Allocator, path: []const u8, b_formato: encdec.BinaraFormato) !void {
    ...
    pub fn deseriigiElBin(allocator: all.Allocator,input: []const u8, b_formato: encdec.BinaraFormato) !TransportCfg {
        return try deseriigiTiponElBin(allocator, TransportCfg, input, b_formato);
    }

    pub fn deseriigiElDosiero(allocator: all.Allocator, path: [:0]const u8, b_formato: encdec.BinaraFormato) !TransportCfg {
