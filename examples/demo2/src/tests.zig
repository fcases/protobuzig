...
// mensaje EXTERNO del contrato (1); los anidados no se testean
// aqui. Generado por protobuzig --ws: si anades mensajes al .proto,
// regenera el workspace.

// API segura generada (r8_api.zig), no el raw. Los wrappers viven
...
test "PackedMsg: round-trip texto + binario" {
    try ronda(r8.PackedMsg);
}
