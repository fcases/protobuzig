...
pub fn seriigiAlBin(self: *Ciudad, allocator: all.Allocator, b_formato: BinaraFormato) ![]const u8 {
    return try seriigiTiponAlBin(allocator, Ciudad, @as(*Ciudad,self), b_formato);
}

pub fn seriigiAlDosiero(self: *Ciudad, allocator: all.Allocator, path: []const u8, b_formato: BinaraFormato) !void {
