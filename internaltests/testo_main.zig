...
pub fn main() !void {
    ...
    dbgPresi("skribu amkaŭ \'zig test internaltests/testo_main.zig\' por testi ĉiujn testojn\n", .{});
}
...
fn fariTeston3() !void {
    ...
    {
        var app_config = pbz.AppConfig.legiElDosiero(mia_asignilo, "internaltests/cfg/App7.pb.cfg", .TF_PROTOBUF) catch unreachable;
        var skribilo: []const u8 = undefined;
...
fn fariTeston4() !void {
    ...
    var app_config = pbz.AppConfig.legiElDosiero(mia_asignilo, "internaltests/cfg/App.zon.cfg", .TF_ZIG_ZON) catch unreachable;
...
fn fariTeston5() !void {
    ...
    var app_config = pbz.AppConfig.legiElDosiero(mia_asignilo, "internaltests/cfg/protocolBus.App.json.cfg", .TF_JSON) catch unreachable;
